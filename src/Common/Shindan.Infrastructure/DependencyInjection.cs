...
using Shindan.Infrastructure.Files;
using Shindan.Infrastructure.Identity;
using Shindan.Infrastructure.Persistence;
using Shindan.Infrastructure.Services;
using Shindan.Infrastructure.Services.Handlers;
...
namespace Shindan.Infrastructure
{
        ...
        public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)//, IWebHostEnvironment environment)
        {
            if (configuration.GetValue<bool>("UseInMemoryDatabase"))
            {
                services.AddDbContext<ApplicationDbContext>(options =>
                    options.UseInMemoryDatabase("ShindanDb"));
            }
            else
            {
                services.AddDbContext<ApplicationDbContext>(options =>
