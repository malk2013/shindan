...
using Shindan.Web.Core.Extensions;
using Shindan.Web.Core.Requests.Identity;
using Shindan.Web.Core.Routes;
    ...
    public class AuthenticationManager : IAuthenticationManager
    {
        ...
        public async Task<IResult> Login(TokenRequest model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                ((ShindanStateProvider)this._authenticationStateProvider).MarkUserAsAuthenticated(model.Email);
        ...
        public async Task<IResult> Logout()
        {
            ...
            ((ShindanStateProvider)_authenticationStateProvider).MarkUserAsLoggedOut();
